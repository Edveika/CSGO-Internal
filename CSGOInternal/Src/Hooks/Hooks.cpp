...
void Hook::Enable()
{
	...
	*(uintptr_t*)ptrToGatewayPtr = (uintptr_t)TrampolineHook(src, dst, len);
	bStatus = true;
}
...
void Hooks::Initialize()
{
	if (GetD3D9Device(d3d9Device, sizeof(d3d9Device)))
	{
		...
		oEndScene = (tEndScene)(TrampolineHook((BYTE*)d3d9Device[42], (BYTE*)hkEndScene, 7));
	}
}

void Hooks::Unhook()
{
	Utils::Patch((BYTE*)d3d9Device[42], (BYTE*)EndSceneBytes, 7);
}